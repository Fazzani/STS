...
namespace aspIdentity.Controllers
{
  ...
  public class AccountController : Controller
  {
    ...
    // GET: /Account/Login
    [AllowAnonymous]
    public ActionResult Process(string returnUrl)
    {
      //TODO : Test if user exist in the Ldap
      if (User.Identity.IsAuthenticated)
        return RedirectToLocal(returnUrl);

      ViewBag.ReturnUrl = returnUrl;
      ViewBag.Title = "Login STS";
      return View();
    }
    //
    ...
    public async Task<ActionResult> Process(LoginViewModel model, string returnUrl)
    {
